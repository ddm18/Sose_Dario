...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<ExceptionData> handleRouteNotFound(HotelNotFoundException ex) {
	...
	public ResponseEntity<ExceptionData> handleMethodArgumentTypeMismatchException(
	...
	public ResponseEntity<ExceptionData> handleIdParsingException(IdParsingException ex) {
		return new ResponseEntity<>(
				new ExceptionData(HttpStatus.BAD_REQUEST, HttpStatus.BAD_REQUEST.value(), ex.getLocalizedMessage()),
	...
	public ResponseEntity<ExceptionData> handleGenericException(Throwable ex) {
		ex.printStackTrace();
		return new ResponseEntity<>(new ExceptionData(HttpStatus.INTERNAL_SERVER_ERROR,
